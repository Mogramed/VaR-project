...
def decision_to_dict(record: DecisionRecord) -> dict[str, Any]:
    ...
    payload.setdefault("requested_delta_position_eur", record.requested_delta_position_eur)
    payload.setdefault("approved_delta_position_eur", record.approved_delta_position_eur)
...
def execution_to_dict(record: ExecutionRecord) -> dict[str, Any]:
    ...
    payload.setdefault("requested_delta_position_eur", record.requested_delta_position_eur)
    payload.setdefault("approved_delta_position_eur", record.approved_delta_position_eur)
    payload.setdefault("executed_delta_position_eur", record.executed_delta_position_eur)
